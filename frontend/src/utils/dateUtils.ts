...
export const formatPhoneNumber = (phoneNumber: string): string => {
  ...
  if (len === 11) {
    ...
    // e.g., 0101234567 (older 01x numbers or some landlines)
...
export const formatChartLabel = (labelValue: string): string => {
  // labelValue is like 'yyyy-MM' (e.g., '2023-10')
  const month = labelValue.substring(5, 7);
